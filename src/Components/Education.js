    ...
    <div className="my-64">
      ...
      <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2">
          ...
          />
          <Details
            type="Web Development (On-Going Course)"
            time="2025-2026 (6-month)"
            place="Ostad "
            info="Relevant courses included HTML, CSS, Tailwind, JavaScript, React, Vue, PHP, Laravel, MySql, Firebase, JWT Authentication, RESTful API Development, Git and GitHub for version control, Deployment and Hosting, Responsive Web Design, UI/UX Principles."
          />
        </ul>
      </div>
    </div>
